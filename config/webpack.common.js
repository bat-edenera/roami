...
var pages = ['index','userinfo','safety','settle','complaint','withdraw','addcate','goodlist','addgood','addkami','kamilist','kamimanage','kamitrash','sold','link','order','log','income','seo','income'];
pages = ['order','log','income','seo','payway'];
var confs = {
	entry: {
